  ...
  testWidgets("take screenshots", (tester) async {
    ...
    await tester.pumpWidget(ProviderScope(
      overrides: [
        ...
        remoteConfigValueProvider(RemoteConfigKeys.showBanner).overrideWithValue(false),
        remoteConfigValueProvider(RemoteConfigKeys.hoyolabLinkEnabled).overrideWithValue(false),
        remoteConfigValueProvider(RemoteConfigKeys.minimumAssetSchemaVersion).overrideWithValue(0),
