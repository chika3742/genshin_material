...
import "../../../routes.dart";
import "../viewmodels/furnishing_bookmark_viewmodel.dart";

/// View that displays furnishing set bookmarks
class FurnishingBookmarkView extends HookConsumerWidget {
  const FurnishingBookmarkView({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final viewModel = ref.read(furnishingBookmarkViewModelProvider.notifier);
          ...
          builder: (context) {
            final counts = useStream(
              useMemoized(() => db.watchFurnishingCraftCounts(set.id)),
                ...
                [];
            final insufficientComponents = set.consistsOf.where((e) =>
                (counts
              ...
              trailing: Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      viewModel.removeFurnishingSetBookmark(
                        context: context,
                        bookmark: bookmark,
                      );
                    },
                      ...
                      return Padding(
                        ...
                        child: ListTile(
                          ...
                          trailing: FurnishingCounter(
                              currentCount: counts
                                      .firstWhereOrNull(
                                          (c) => c.furnishingId == e.furnishingId)
                                      ?.count ??
                                  0,
                              requiredCount: e.quantity,
                              onChanged: (value) {
                                viewModel.updateFurnishingCraftCount(
                                  setId: set.id,
                                  furnishingId: e.furnishingId,
                                  count: value,
                                );
                              }),
                        ),
