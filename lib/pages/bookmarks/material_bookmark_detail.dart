...
class MaterialBookmarkDetail extends StatelessWidget {
  const MaterialBookmarkDetail({super.key, required this.materialId, required this.hasWeapon});
      ...
      builder: (context, scrollController) {
        return HookConsumer(
          builder: (context, ref, child) {
            ...
            final groups = groupBookmarksByHash<String, BookmarkWithMaterialDetails>(
              bookmarks,
            ...
            final headerIndexes = _calculateHeaderIndexes(groups);
  ...
  /// Calculate the indices where headers should appear in the list
  List<int> _calculateHeaderIndexes(List<BookmarkGroup> groups) {
