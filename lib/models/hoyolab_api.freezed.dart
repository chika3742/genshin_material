...
mixin _$HoyolabApiResult<T> {
 ...
 int get retcode; String get message; T? get data;
...
class _HoyolabApiResult<T> extends HoyolabApiResult<T> {
  const _HoyolabApiResult({required this.retcode, required this.message, this.data}): super._();
  factory _HoyolabApiResult.fromJson(Map<String, dynamic> json,T Function(Object?) fromJsonT) => _$HoyolabApiResultFromJson(json,fromJsonT);

@override final  int retcode;
...
mixin _$HyvServer {
 ...
 String get region; String get name;
...
class _HyvServer implements HyvServer {
  ...
  factory _HyvServer.fromJson(Map<String, dynamic> json) => _$HyvServerFromJson(json);
...
@JsonKey(name: "account_name") String get accountName;
...
class _HyvUserInfo implements HyvUserInfo {
  const _HyvUserInfo({@JsonKey(name: "account_name") required this.accountName});
  factory _HyvUserInfo.fromJson(Map<String, dynamic> json) => _$HyvUserInfoFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$HyvUserInfoToJson(this, );
}
...
@JsonKey(name: "game_uid") String get uid; String get nickname; int get level;
...
class _HyvUserGameRole implements HyvUserGameRole {
  const _HyvUserGameRole({@JsonKey(name: "game_uid") required this.uid, required this.nickname, required this.level});
  factory _HyvUserGameRole.fromJson(Map<String, dynamic> json) => _$HyvUserGameRoleFromJson(json);

@override@JsonKey(name: "game_uid") final  String uid;
...
@override
Map<String, dynamic> toJson() {
  return _$HyvUserGameRoleToJson(this, );
}
...
@override final  String name;
@override@JsonKey(name: "level_current") final  int currentLevel;
@override@JsonKey(name: "max_level") final  int maxLevel;
 final  List<AvatarSkill> _skills;
@override@JsonKey(name: "skill_list") List<AvatarSkill> get skills {
...
@override
Map<String, dynamic> toJson() {
  return _$AvatarListResultItemToJson(this, );
}
...
@JsonKey(name: "group_id") int get groupId;@JsonKey(name: "max_level") int get maxLevel;@JsonKey(name: "level_current") int get currentLevel;
...
class _AvatarSkill implements AvatarSkill {
  const _AvatarSkill({@JsonKey(name: "group_id") required this.groupId, @JsonKey(name: "max_level") required this.maxLevel, @JsonKey(name: "level_current") required this.currentLevel});
  factory _AvatarSkill.fromJson(Map<String, dynamic> json) => _$AvatarSkillFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$AvatarSkillToJson(this, );
}
...
@JsonKey(name: "avatar_auth") int get avatarAuth;
...
class _AvatarAuth implements AvatarAuth {
  ...
  factory _AvatarAuth.fromJson(Map<String, dynamic> json) => _$AvatarAuthFromJson(json);

@override@JsonKey(name: "avatar_auth") final  int avatarAuth;


@override
Map<String, dynamic> toJson() {
  return _$AvatarAuthToJson(this, );
}
...
@JsonKey(name: "game_id", unknownEnumValue: GameType.starrail) GameType get gameType;@JsonKey(name: "data_switches") List<DataSwitchMetadata> get dataSwitches;
...
@override@JsonKey(name: "data_switches") List<DataSwitchMetadata> get dataSwitches {
...
@override
Map<String, dynamic> toJson() {
  return _$GameRecordCardToJson(this, );
}
...
@JsonKey(name: "switch_id", unknownEnumValue: DataSwitchType.enableBattleChronicle) DataSwitchType get switchId;@JsonKey(name: "is_public") bool get isPublic;
...
class _DataSwitchMetadata implements DataSwitchMetadata {
  const _DataSwitchMetadata({@JsonKey(name: "switch_id", unknownEnumValue: DataSwitchType.enableBattleChronicle) required this.switchId, @JsonKey(name: "is_public") required this.isPublic});
  factory _DataSwitchMetadata.fromJson(Map<String, dynamic> json) => _$DataSwitchMetadataFromJson(json);

@override@JsonKey(name: "switch_id", unknownEnumValue: DataSwitchType.enableBattleChronicle) final  DataSwitchType switchId;
@override@JsonKey(name: "is_public") final  bool isPublic;


@override
Map<String, dynamic> toJson() {
  return _$DataSwitchMetadataToJson(this, );
}
...
@JsonKey(name: "current_resin") int get currentResin;@JsonKey(name: "resin_recovery_time") String get resinRecoveryTime;@JsonKey(name: "current_home_coin") int get currentHomeCoin;
...
class _DailyNote implements DailyNote {
  const _DailyNote({@JsonKey(name: "current_resin") required this.currentResin, @JsonKey(name: "resin_recovery_time") required this.resinRecoveryTime, @JsonKey(name: "current_home_coin") required this.currentHomeCoin});
  factory _DailyNote.fromJson(Map<String, dynamic> json) => _$DailyNoteFromJson(json);

@override@JsonKey(name: "current_resin") final  int currentResin;
@override@JsonKey(name: "resin_recovery_time") final  String resinRecoveryTime;
@override@JsonKey(name: "current_home_coin") final  int currentHomeCoin;


@override
Map<String, dynamic> toJson() {
  return _$DailyNoteToJson(this, );
}
...
@JsonKey(name: "avatar_id") int? get avatarId;@JsonKey(name: "avatar_level_current") int? get currentAvatarLevel;@JsonKey(name: "element_attr_id") int? get elementAttrId;@JsonKey(name: "avatar_level_target") int? get targetAvatarLevel;@JsonKey(name: "skill_list") List<CalcComputeSkill>? get skills; CalcComputeWeapon? get weapon;
/// Create a copy of CalcComputeItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CalcComputeItemCopyWith<CalcComputeItem> get copyWith => _$CalcComputeItemCopyWithImpl<CalcComputeItem>(this as CalcComputeItem, _$identity);
...
abstract mixin class $CalcComputeItemCopyWith<$Res>  {
  factory $CalcComputeItemCopyWith(CalcComputeItem value, $Res Function(CalcComputeItem) _then) = _$CalcComputeItemCopyWithImpl;
@useResult
$Res call({
@JsonKey(name: "avatar_id") int? avatarId,@JsonKey(name: "avatar_level_current") int? currentAvatarLevel,@JsonKey(name: "element_attr_id") int? elementAttrId,@JsonKey(name: "avatar_level_target") int? targetAvatarLevel,@JsonKey(name: "skill_list") List<CalcComputeSkill>? skills, CalcComputeWeapon? weapon
});
...
as int?,targetAvatarLevel: freezed == targetAvatarLevel ? _self.targetAvatarLevel : targetAvatarLevel // ignore: cast_nullable_to_non_nullable
as int?,skills: freezed == skills ? _self.skills : skills // ignore: cast_nullable_to_non_nullable
as List<CalcComputeSkill>?,weapon: freezed == weapon ? _self.weapon : weapon // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: "avatar_level_current") final  int? currentAvatarLevel;
@override@JsonKey(name: "element_attr_id") final  int? elementAttrId;
@override@JsonKey(name: "avatar_level_target") final  int? targetAvatarLevel;
 final  List<CalcComputeSkill>? _skills;
@override@JsonKey(name: "skill_list") List<CalcComputeSkill>? get skills {
  final value = _skills;
...
@override final  CalcComputeWeapon? weapon;

/// Create a copy of CalcComputeItem
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$CalcComputeItemCopyWith<_CalcComputeItem> get copyWith => __$CalcComputeItemCopyWithImpl<_CalcComputeItem>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CalcComputeItemToJson(this, );
}
...
/// @nodoc
abstract mixin class _$CalcComputeItemCopyWith<$Res> implements $CalcComputeItemCopyWith<$Res> {
  factory _$CalcComputeItemCopyWith(_CalcComputeItem value, $Res Function(_CalcComputeItem) _then) = __$CalcComputeItemCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: "avatar_id") int? avatarId,@JsonKey(name: "avatar_level_current") int? currentAvatarLevel,@JsonKey(name: "element_attr_id") int? elementAttrId,@JsonKey(name: "avatar_level_target") int? targetAvatarLevel,@JsonKey(name: "skill_list") List<CalcComputeSkill>? skills, CalcComputeWeapon? weapon
});
...
/// Create a copy of CalcComputeItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? avatarId = freezed,Object? currentAvatarLevel = freezed,Object? elementAttrId = freezed,Object? targetAvatarLevel = freezed,Object? skills = freezed,Object? weapon = freezed,}) {
...
mixin _$CalcComputeSkill {
 ...
 int get id;@JsonKey(name: "level_current") int get currentLevel;@JsonKey(name: "level_target") int get targetLevel;
...
class _CalcComputeSkill implements CalcComputeSkill {
  const _CalcComputeSkill({required this.id, @JsonKey(name: "level_current") required this.currentLevel, @JsonKey(name: "level_target") required this.targetLevel});
  

@override final  int id;
@override@JsonKey(name: "level_current") final  int currentLevel;
@override@JsonKey(name: "level_target") final  int targetLevel;


@override
Map<String, dynamic> toJson() {
  return _$CalcComputeSkillToJson(this, );
}
...
mixin _$AvatarWeapon {
 ...
 int get id;@JsonKey(name: "max_level") int get maxLevel;@JsonKey(name: "level_current") int get currentLevel;@JsonKey(name: "weapon_cat_id") int get categoryId;@JsonKey(name: "weapon_level") int get rarity; String get name; String get icon;
...
class _AvatarWeapon implements AvatarWeapon {
  const _AvatarWeapon({required this.id, @JsonKey(name: "max_level") required this.maxLevel, @JsonKey(name: "level_current") required this.currentLevel, @JsonKey(name: "weapon_cat_id") required this.categoryId, @JsonKey(name: "weapon_level") required this.rarity, required this.name, required this.icon});
  factory _AvatarWeapon.fromJson(Map<String, dynamic> json) => _$AvatarWeaponFromJson(json);

@override final  int id;
@override@JsonKey(name: "max_level") final  int maxLevel;
@override@JsonKey(name: "level_current") final  int currentLevel;
@override@JsonKey(name: "weapon_cat_id") final  int categoryId;
@override@JsonKey(name: "weapon_level") final  int rarity;
@override final  String name;
...
@override
Map<String, dynamic> toJson() {
  return _$AvatarWeaponToJson(this, );
}
...
mixin _$CalcComputeWeapon {
 ...
 int get id;@JsonKey(name: "max_level") int? get maxLevel;@JsonKey(name: "level_current") int get currentLevel;@JsonKey(name: "level_target") int get targetLevel;@JsonKey(name: "weapon_cat_id") int? get categoryId;@JsonKey(name: "weapon_level") int get rarity; String get name; String? get icon;
...
class _CalcComputeWeapon implements CalcComputeWeapon {
  const _CalcComputeWeapon({required this.id, @JsonKey(name: "max_level") this.maxLevel, @JsonKey(name: "level_current") required this.currentLevel, @JsonKey(name: "level_target") required this.targetLevel, @JsonKey(name: "weapon_cat_id") this.categoryId, @JsonKey(name: "weapon_level") required this.rarity, required this.name, this.icon});
...
@override
Map<String, dynamic> toJson() {
  return _$CalcComputeWeaponToJson(this, );
}
...
@JsonKey(name: "overall_consume") List<CalcConsumptionItem> get overallConsume;
...
@override@JsonKey(name: "overall_consume") List<CalcConsumptionItem> get overallConsume {
...
@override
Map<String, dynamic> toJson() {
  return _$CalcResultToJson(this, );
}
...
mixin _$CalcConsumptionItem {
 ...
 int get id;@JsonKey(name: "lack_num") int get lackNum; int get num;
...
class _CalcConsumptionItem implements CalcConsumptionItem {
  const _CalcConsumptionItem({required this.id, @JsonKey(name: "lack_num") required this.lackNum, required this.num});
  factory _CalcConsumptionItem.fromJson(Map<String, dynamic> json) => _$CalcConsumptionItemFromJson(json);

@override final  int id;
@override@JsonKey(name: "lack_num") final  int lackNum;
@override final  int num;


@override
Map<String, dynamic> toJson() {
  return _$CalcConsumptionItemToJson(this, );
}
