...
class IngredientByType implements Ingredient {
  const IngredientByType(
      ...
      this.craftLevel,
      final Map<String, MaterialId?>? targetSpecific,
      final String? $type})
      : _targetSpecific = targetSpecific,
        $type = $type ?? 'byType';
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._targetSpecific, _targetSpecific));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, type, quantity, craftLevel,
      const DeepCollectionEquality().hash(_targetSpecific));
...
class _IngredientLevels implements IngredientLevels {
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$IngredientLevelsToJson(
      this,
    );
  }
...
mixin _$IngredientPurposes {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(purposes));
...
class _IngredientPurposes implements IngredientPurposes {
  const _IngredientPurposes({required final Map<Purpose, String> purposes})
      : _purposes = purposes;
  factory _IngredientPurposes.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$IngredientPurposesToJson(
      this,
    );
  }
...
mixin _$IngredientConfigurations {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is IngredientConfigurations &&
...
class _IngredientConfigurations extends IngredientConfigurations {
  const _IngredientConfigurations(
      ...
      : _expItems = expItems,
        _rarities = rarities,
        _sliders = sliders,
        _ingredientTables = ingredientTables,
        super._();
  factory _IngredientConfigurations.fromJson(Map<String, dynamic> json) =>
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IngredientConfigurations &&
