...
@override final  LocalizedText? note;
@override final  DropRateTarget target;
 final  List<DropRate> _originalRate;
@override List<DropRate> get originalRate {
...
mixin _$DropRateTarget {
 ...
 String? get category; int? get rarity; List<String>? get ids;
...
@override
Map<String, dynamic> toJson() {
  return _$DropRateTargetToJson(this, );
}
...
mixin _$DropRate {
 ...
 int get lowerAR; double get rate;
...
class _DropRate implements DropRate {
  ...
  factory _DropRate.fromJson(Map<String, dynamic> json) => _$DropRateFromJson(json);

@override final  int lowerAR;
@override final  double rate;


@override
Map<String, dynamic> toJson() {
  return _$DropRateToJson(this, );
}
