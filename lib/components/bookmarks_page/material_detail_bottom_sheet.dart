...
Future<void> showMaterialBookmarkDetailBottomSheet({required BuildContext context, required String? materialId, required bool hasWeapon}) {
  return showModalBottomSheet(
    context: context,
    showDragHandle: true,
    isScrollControlled: true,
    builder: (context) {
      return MaterialBookmarkDetailBottomSheet(
...
class MaterialBookmarkDetailBottomSheet extends StatelessWidget {
  const MaterialBookmarkDetailBottomSheet({super.key, required this.materialId, required this.hasWeapon});
                ...
                itemBuilder: (context, index) {
                  ...
                  if (headerIndexes[headerIndexesIndex] == index) {
                    return Padding(
                      ...
                      child: BookmarkPurposeHeader(group: groups[headerIndexesIndex]),
                    );
                  }
