...
$ArtifactBookmarkDialogStateCopyWith<ArtifactBookmarkDialogState> get copyWith => _$ArtifactBookmarkDialogStateCopyWithImpl<ArtifactBookmarkDialogState>(this as ArtifactBookmarkDialogState, _$identity);
...
as Map<ArtifactPieceTypeId, StatId?>,subStats: null == subStats ? _self.subStats : subStats // ignore: cast_nullable_to_non_nullable
as List<StatId>,
  ));
}
...
class _ArtifactBookmarkDialogState implements ArtifactBookmarkDialogState {
  const _ArtifactBookmarkDialogState({this.characterId, this.firstSetId, this.secondSetId, this.pieceId, final  Map<ArtifactPieceTypeId, StatId?> mainStats = const {}, final  List<StatId> subStats = const []}): _mainStats = mainStats,_subStats = subStats;
...
@override@JsonKey() Map<ArtifactPieceTypeId, StatId?> get mainStats {
...
@override@JsonKey() List<StatId> get subStats {
...
@pragma('vm:prefer-inline')
_$ArtifactBookmarkDialogStateCopyWith<_ArtifactBookmarkDialogState> get copyWith => __$ArtifactBookmarkDialogStateCopyWithImpl<_ArtifactBookmarkDialogState>(this, _$identity);
...
/// @nodoc
abstract mixin class _$ArtifactBookmarkDialogStateCopyWith<$Res> implements $ArtifactBookmarkDialogStateCopyWith<$Res> {
...
as Map<ArtifactPieceTypeId, StatId?>,subStats: null == subStats ? _self._subStats : subStats // ignore: cast_nullable_to_non_nullable
as List<StatId>,
  ));
}
