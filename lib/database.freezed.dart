...
mixin _$Bookmark {
 ...
 int get id; BookmarkType get type; String get characterId; DateTime get createdAt; String get groupHash;



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Bookmark&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.characterId, characterId) || other.characterId == characterId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.groupHash, groupHash) || other.groupHash == groupHash));
}


@override
int get hashCode => Object.hash(runtimeType,id,type,characterId,createdAt,groupHash);
...
class _Bookmark implements Bookmark {
  const _Bookmark({required this.id, required this.type, required this.characterId, required this.createdAt, required this.groupHash});
...
@override final  String groupHash;
