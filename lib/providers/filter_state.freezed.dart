...
mixin _$CharacterFilterState {
  ...
  $CharacterFilterStateCopyWith<CharacterFilterState> get copyWith =>
      _$CharacterFilterStateCopyWithImpl<CharacterFilterState>(
          this as CharacterFilterState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CharacterFilterState &&
...
abstract mixin class $CharacterFilterStateCopyWith<$Res> {
  factory $CharacterFilterStateCopyWith(CharacterFilterState value,
          $Res Function(CharacterFilterState) _then) =
      _$CharacterFilterStateCopyWithImpl;
  @useResult
  $Res call(
...
class _CharacterFilterState extends CharacterFilterState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CharacterFilterStateCopyWith<_CharacterFilterState> get copyWith =>
      __$CharacterFilterStateCopyWithImpl<_CharacterFilterState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CharacterFilterState &&
            (identical(other.possessionStatus, possessionStatus) ||
                other.possessionStatus == possessionStatus) &&
            (identical(other.rarity, rarity) || other.rarity == rarity) &&
            (identical(other.element, element) || other.element == element) &&
...
/// @nodoc
abstract mixin class _$CharacterFilterStateCopyWith<$Res>
    implements $CharacterFilterStateCopyWith<$Res> {
  factory _$CharacterFilterStateCopyWith(_CharacterFilterState value,
          $Res Function(_CharacterFilterState) _then) =
      __$CharacterFilterStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {PossessionStatus? possessionStatus,
...
mixin _$ArtifactFilterState {
  ...
  $ArtifactFilterStateCopyWith<ArtifactFilterState> get copyWith =>
      _$ArtifactFilterStateCopyWithImpl<ArtifactFilterState>(
          this as ArtifactFilterState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ArtifactFilterState &&
...
abstract mixin class $ArtifactFilterStateCopyWith<$Res> {
  factory $ArtifactFilterStateCopyWith(
          ArtifactFilterState value, $Res Function(ArtifactFilterState) _then) =
      _$ArtifactFilterStateCopyWithImpl;
  @useResult
...
class _ArtifactFilterState implements ArtifactFilterState {
  const _ArtifactFilterState({final List<String> tags = const []})
      : _tags = tags;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ArtifactFilterStateCopyWith<_ArtifactFilterState> get copyWith =>
      __$ArtifactFilterStateCopyWithImpl<_ArtifactFilterState>(
          this, _$identity);
...
/// @nodoc
abstract mixin class _$ArtifactFilterStateCopyWith<$Res>
    implements $ArtifactFilterStateCopyWith<$Res> {
  factory _$ArtifactFilterStateCopyWith(_ArtifactFilterState value,
          $Res Function(_ArtifactFilterState) _then) =
      __$ArtifactFilterStateCopyWithImpl;
  @override
  @useResult
  $Res call({List<String> tags});
}
